...
export class GlobalVars {
  ...
  static myName = "Md Jahid Hasan Anik";
  static myOccupation = "Frontend Developer";
  static myDetails =
    "Hello, I am Md Jahid Hasan Anik. I love Programming, making web Application. I started programming as a hobby since 2017. Wrote my first program by using C. Later I learned C++, Java, JavaScript etc, Worked in several libraries & frameworks like ReactJS, NextJS, worked using several technologies like Git. It does feel amazing to see myself improving. Hope to improve everything around me one day...";
  static myLeftAvatarImage = null;
  static myRightAvatarImage = null;

  static routes: Array<string> = ["About", "Skills", "Works", "Contact"];

  static bottomLinks: Array<NavBottomLinksInterface> = [
    {
      svgPath: OurIcons.whatsappIcon,
      link: "https://api.whatsapp.com/send?phone=8801744722883",
    },
    {
      svgPath: OurIcons.emailIcon,
      link: "mailto:jahidhasananik.official@gmail.com",
    },
    {
      svgPath: OurIcons.facebookIcon,
      link: "https://www.facebook.com/jahed.anik",
    },
  ];
  ...
  static works: Array<TitledListItemInterface> = [
    {
      ...
      arr: [
        ...
        },
        {
          title: "Impomek",
          logo: "/ball.svg",
          desc: "Impromek | 1:1 Online Training with College & Pro Athletes",
          link: "https://www.impromek.com/",
        },
        {
          title: "Charge-on-site",
          logo: "/cos.png",
          desc: "Charge-on-site | Number 1 site for charging you EV",
          link: "https://dev.chargeonsite.com/",
        },
        {
          title: "Charge-on-site (Admin panel)",
          logo: "/cos.png",
          desc: "Charge-on-site | Number 1 site for charging you EV",
          link: "https://dev-admin.chargeonsite.com/",
        },
      ],
    },
  ];
  ...
  static contacts: Array<TitledListItemInterface> = [
    {
      ...
      arr: [
        ...
        },
        {
          ...
          desc: "jahidhasananik.official@gmail.com",
          link: "mailto:jahidhasananik.official@gmail.com",
        },
      ],
    },
